...
const Profile = ({ student, i }) => (
  ...
  >
    ...
    <Typography sx={{ fontSize: 16, height: "100px" }}>
      Sed ut perspiciatis unde omnis iste natus error sit dolor {student.first}{" "}
      {student.last} {student.first} {student.last}
      {student.first} {student.last} {student.first} {student.last}
    </Typography>
    <Stack sx={{ justifyContent: "space-around" }} direction="horizontal">
      <Stack>
